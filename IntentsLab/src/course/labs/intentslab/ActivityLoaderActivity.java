...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent exp_intent = new Intent(ActivityLoaderActivity.this, course.labs.intentslab.ExplicitlyLoadedActivity.class);	
		//Start an Activity using that intent and the request code defined above
		startActivityForResult(exp_intent, GET_TEXT_REQUEST_CODE);
	}
